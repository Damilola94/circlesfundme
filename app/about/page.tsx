        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-16">
            <div className="space-y-6">
              <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 font-outfit">
              ...
              <p className="text-gray-600 leading-relaxed text-lg font-outfit">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
              {stats.map((stat, index) => (
                <div key={index} className="text-center text-white">
                  <div className="text-3xl lg:text-4xl font-bold mb-2 font-outfit">
                    {stat.value}
                  </div>
                  <div className="text-sm lg:text-base opacity-90 font-outfit">
                    {stat.label}
                  </div>
                </div>
              ))}
