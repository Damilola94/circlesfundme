...
export default function WeeklySchemePage() {
  const breadcrumbItems = [
    { label: "Home", href: "/" },
    { label: "Schemes", href: "#" },
    { label: "Daily Scheme", href: "/schemes/daily" },
  ]
const eligibilityRequirementsDaily = [
  "Participation in the CirclesFundMe Daily Contribution Scheme for at least three months.",
  "Proof of a physical business premises.",
  "A good credit history.",
  "A direct debit setup for your corporate account.",
  "A corporate account demonstrating daily sales revenue of at least five times your daily contribution for at least one year.",
...
const loanTermsDaily = [
  "A loan management fee of 6% per annum.",
  "The repayment duration is 365 days, utilizing your daily contributions.",
  "A daily membership service fee of 0.052% of the principal loan applies.",
]
      ...
      <main className="py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="p-8">
              <h1 className="text-3xl font-bold text-gray-900 mb-6 font-outfit">Daily Contribution Scheme</h1>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-gray-400 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-gray-700 font-outfit">Do you have a consistent daily sales revenue stream?</p>
                </div>
              </div>

              <p className="text-gray-600 leading-relaxed mb-4 font-outfit">
                If so, the CirclesFundme Daily Contribution Scheme is designed specifically for MSME operators like you
                who have regular revenues.
              </p>

              <p className="text-gray-600 leading-relaxed font-outfit">
                By signing up for the CirclesFundme Daily Contribution Scheme, you can access a loan amount of up to 365
                times your daily contributions as working capital loan. 
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-16 mb-12">
            <div className="bg-primary/5 rounded-lg p-6">
              ...
              <div className="space-y-4">
                {eligibilityRequirementsDaily.map((requirement, index) => (
