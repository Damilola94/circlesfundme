      ...
      <main className="py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="p-8">
              <h1 className="text-3xl font-bold text-gray-900 mb-6">Weekly Scheme</h1>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-gray-400 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-gray-700">Do you have a consistent daily or weekly sales revenue stream?</p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-16 mb-12">
            <div className="bg-primary/5 rounded-lg p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">Eligibility Requirements</h2>
            ...
            <div className="bg-primary/5 rounded-lg p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">Terms of the Working Capital Loan</h2>
              <div className="space-y-4">
